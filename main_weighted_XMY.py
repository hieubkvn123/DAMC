...
from models.weighted_XMY import Weighted_XMY
...
def main(args):
    ...
    # Initialize wandb
    wandb.init(project='Weighted_XMY_4_experimentation', 
               name=f'Weighted_XMY-dataset={dataset_name}, p={p_value}, Latent dim: {latent_side_info}, Lambda_: {lambda_}',
    ...
    model = Weighted_XMY(wandb.config, dataset_name)
