    ...
    do
        ...
        # do
            ...
            do
                ...
                python main_weighted_XMY.py --alpha $alpha --dataset $dataset --p_value $p_value --step $step --lr_M $lr_M --lr_ae $lr_ae --latent_side_info $latent_side_info --latent_M $latent_side_info --lambda_ $lambda_
