...
dataset='douban' # Example dataset name
p_values=(0.05)       # Example p_value
model='Unweighted_E_ATR'
step=7000         # Example step size
lr_M=0.01
lr_ae=0.01

latent_side_infos=(16)
lambdas=(0 0.001 0.01 0.1 1 10 20 100 1000 10000)
    ...
    do
        ...
        # do
            ...
            do
                ...
                python main_unweighted_e_atr.py --dataset $dataset --p_value $p_value --step $step --lr_M $lr_M --lr_ae $lr_ae --latent_side_info $latent_side_info --latent_M $latent_side_info --lambda_ $lambda_
