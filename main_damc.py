...
def main(args):
    ...
    # Initialize wandb
    wandb.init(project='DAMC', 
               name=f'DAMC-dataset={dataset_name}, p={p_value}, Latent dim: {latent_side_info}, Lambda_: {lambda_}',
    ...
    model = DAMC(wandb.config, dataset_name)
